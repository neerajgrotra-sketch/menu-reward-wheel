    ...
    <footer className="bg-[#111111] px-4 py-12 text-white sm:px-6">
      <div className="mx-auto grid max-w-6xl gap-10 md:grid-cols-[1.2fr_2fr]">
        <div>
          ...
          <p className="mt-4 max-w-sm text-sm font-medium leading-6 text-white/60">QR-powered restaurant games that turn menu attention into orders, coupons, and measurable redemptions.</p>
