...
function RestaurantIcon(): JSX.Element {
  return (
    <div className="relative mx-auto mb-8 flex justify-center lg:mb-10">
      <div className="relative flex h-44 w-44 items-center justify-center rounded-[2.5rem] border border-white/20 bg-white/10 shadow-[0_25px_55px_rgba(0,0,0,0.22)] backdrop-blur-sm sm:h-56 sm:w-56">
        <div className="absolute inset-0 rounded-[2.5rem] bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.22),transparent_65%)]" />

        <div className="relative flex h-28 w-28 flex-col items-center justify-center rounded-[2rem] bg-white shadow-2xl sm:h-36 sm:w-36">
          <div className="absolute top-0 h-5 w-full rounded-t-[2rem] bg-[#2A211C]" />

          <div className="absolute top-5 flex h-7 w-full overflow-hidden border-y border-orange-300">
          ...
          <div className="mt-8 flex items-end gap-4">
            <div className="h-10 w-10 rounded-xl border-[3px] border-[#2A211C] bg-gradient-to-b from-[#FFD06A] to-[#FF8D18]" />

            <div className="flex h-16 w-12 flex-col rounded-t-xl border-[4px] border-[#2A211C] bg-[#1B1715]">
              <div className="m-2 flex-1 rounded-md bg-gradient-to-b from-[#FFD06A] to-[#FF8D18]" />
            </div>
        ...
        <div className="absolute -left-3 top-1/2 h-10 w-3 -translate-y-1/2 rotate-[-35deg] rounded-full bg-yellow-300 shadow-[0_0_18px_rgba(255,220,100,0.8)]" />
        <div className="absolute -right-3 top-1/2 h-10 w-3 -translate-y-1/2 rotate-[35deg] rounded-full bg-yellow-300 shadow-[0_0_18px_rgba(255,220,100,0.8)]" />
      </div>
    </div>
  );
}
