      ...
      <section className="mx-auto max-w-4xl">
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm font-bold text-stone-500">Super Admin / Homepage Content</p>
          </div>
        ...
        <div className="mt-6 rounded-[2rem] bg-white p-6 shadow-xl">
          ...
          <h2 className="mt-3 text-4xl font-black">Homepage content control is ready for database wiring.</h2>
          <p className="mt-3 text-sm font-semibold leading-6 text-stone-600">
            This protected route reserves the future area for hero copy, homepage sections, badges, feature cards, calls to action, and footer content.
          </p>
        </div>
      </section>
    </main>
