...
export default function PromotionsPage() {
  ...
  const visiblePromotions = mode === 'create'
    ? promotions.filter((p) => statusOf(p) === 'draft')
    : promotions.filter((p) => filter === 'all' || statusOf(p) === filter);
