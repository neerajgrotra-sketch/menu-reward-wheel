...
function MiniOpenDoor() {
  return <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-3xl bg-gradient-to-br from-slate-100 via-stone-100 to-slate-200 text-4xl shadow-inner">🚪</div>;
}
